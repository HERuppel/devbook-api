...
func Get(w http.ResponseWriter, r *http.Request) {
	...
	usersRepository := repositories.NewUserRepository(db)
	user, err := usersRepository.Get(id)
	if err != nil {
		responses.Error(w, http.StatusInternalServerError, err)
		return
	}
...
func Update(w http.ResponseWriter, r *http.Request) {
	...
	usersRepository := repositories.NewUserRepository(db)
	if err = usersRepository.Update(id, user); err != nil {
		responses.Error(w, http.StatusInternalServerError, err)
		return
	}
...
func UnfollowUser(w http.ResponseWriter, r *http.Request) {
	...
	if followerId == id {
		responses.Error(w, http.StatusForbidden, errors.New("CANNOT_UNFOLLOW_SELF"))
		return
	}
	...
	usersRepository := repositories.NewUserRepository(db)
	if err = usersRepository.Unfollow(id, followerId); err != nil {
		responses.Error(w, http.StatusInternalServerError, err)
		return
	}
...
func FetchFollowers(w http.ResponseWriter, r *http.Request) {
	...
	usersRepository := repositories.NewUserRepository(db)
	followers, err := usersRepository.FetchFollowers(id)
	if err != nil {
		responses.Error(w, http.StatusInternalServerError, err)
		return
	}
...
func FetchFollowing(w http.ResponseWriter, r *http.Request) {
	...
	usersRepository := repositories.NewUserRepository(db)
	following, err := usersRepository.FetchFollowing(id)
	if err != nil {
		responses.Error(w, http.StatusInternalServerError, err)
		return
	}
